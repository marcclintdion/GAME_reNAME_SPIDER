...
//      "         NdotL3                    =  max(dot(normal, lightPosition_PASS_03.xyz), 0.0);                                                      \n"                       
      ...
      "                                     + texture2D(Texture1, varTexcoord.st)* NdotL2                            \n" 
   //   "                                   + texture2D(Texture1, varTexcoord.st)* NdotL3 * NdotL3                                     \n" 
      "                                     + texture2D(Texture1, varTexcoord.st)* NdotL4)*0.4                                 \n" 
      
      
      "                                     +  gloss_01 +  gloss_02+  gloss_04)*texture2D(Texture1, varTexcoord.st) * shadowVal;                                                             \n"                       
